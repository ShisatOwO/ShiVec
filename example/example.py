...
vec3 = ShiVec(1, 2, 3)
print(vec3.get_vec())  # calling get_vec() on any ShiVec object will return its Vector as tuple.

# This one has 2...
vec2 = ShiVec(11, 22)

# And this one 5
vec5 = ShiVec(10, 20, 30, 40, 50)
...
vecB = ShiVec(size=3, default=2)


# of course you can combine these two methods
vecC = ShiVec(1, 2, size=4)


# ShiVec also has macros by which you can reference certain positions of a Vector
...
vecRGBA = ShiVec(size=4, default=255, macros=("r", "g", "b", "a"))
vecRGBA.g = 0
vecRGBA.b = 0
